		...
		<div class="slider">
			<div class="container">
				<div class="slide-bank">
					<div class="slide">
						<img src="<?php echo get_template_directory_uri(); ?>/images/FirstSlide.jpg" title="<p>Water is good for you. Your hair needs it too!</p>">
					</div>
					<div class="slide">
						<img src="<?php echo get_template_directory_uri(); ?>/images/SecondSlide.jpg" title="<p class='left'>Harsh chemicals are not good for you! Why would they be good for your hair?</p>">
					</div>
					<div class="slide">
						<img src="<?php echo get_template_directory_uri(); ?>/images/Healthilocks_slide1.jpg" title="<p class='left'>15 minute treatment to have gorgeous hair for 12 weeks? It's true!</p>">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="product-carousel">
				<div class="product-bank">
					<div class="product left">
						<img src="<?php echo get_template_directory_uri(); ?>/images/product.png">
						<img class="thumb" src="<?php echo get_template_directory_uri(); ?>/images/product-large.png">
						<h3>Daily Shampoo</h3>
						...
						<div class="product mid">
							...
							<img class="divet" src="<?php echo get_template_directory_uri(); ?>/images/divet.png">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris.</p>
								<span class="price">$42.00</span>
